...
function CommEdArticle() {
    return (
        <div>
            ...
            <p>CommEd is a full-stack project that I created by myself using Javascript, React, React-tex, Formik, Python, Flask, SQLalchemy, and CSS. I began working on this project on January 29th and presented a minimum viable product to my cohort on February 15th. Even though my bootcamp course is completed, I will enthusiastically continue development.</p>
            ...
            <p>I welcome you to try my code for yourself. You can obtain the code from github here <a href='https://github.com/EvanLosh/CommEd'>https://github.com/EvanLosh/CommEd</a>. To run the server, enter the following in a terminal in the prject directory:</p>
            ...
            <h1>Demo: I am working on a youtube video in which I demo my project</h1>
